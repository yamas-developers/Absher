...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    print(
        "MK: localization2: ${Directionality.of(context).toString() == 'TextDirection.ltr'}");
    print("tr(): ${getString("app_name")}");
    logWarning("MJ: in location permission, ${context.read<SettingsProvider>().locationPermission}");
    debugPrint('\x1B[34m${"hello world"}\x1B[0m');
    return Scaffold(
      appBar: AppBar(
